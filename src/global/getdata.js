...
function getInlineStringPlainText(cell) {
    if (
        cell == null ||
        !cell.ct ||
...
export function getcellvalue(r, c, data, type) {
    ...
    if(getObjType(d_value) == "object"){
        ...
        if ((retv == null || retv === undefined) && isInlineStringCT(d_value.ct)) {
            retv = getInlineStringPlainText(d_value);
        }
    }
